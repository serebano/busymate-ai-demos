...
const homeHtml = renderLandingHome({ brand: BRAND, realSiteUrl: SITE_ORIGIN, realSiteLabel: "Wix (free plan)" });
const homeMd = renderLandingMarkdown({ brand: BRAND, realSiteUrl: SITE_ORIGIN, realSiteLabel: "Wix" });
